...
export const acquireFloatAppSelfAnalyses = ({
  url,
  per_page,
  accountId,
  fin_callback
...
export const acquireFloatAppSelfLatestUpdatedAnalyses = (
...
export const acquireFloatAppSelfMostSharedAnalyses = ({
  url,
  per_page,
  accountId,
  fin_callback
...
export const acquireFloatAppSelfMostFavoriteAnalyses = ({
  url,
  per_page,
  accountId,
  fin_callback
...
export const acquireFloatAppSelfMostLikedAnalyses = ({
  url,
  per_page,
  accountId,
  fin_callback
...
export const acquireFloatAppSelfMostCommentAnalyses = ({
  url,
  per_page,
  accountId,
  fin_callback
...
export const acquireFloatAppSelfMostViewAnalyses = ({
  url,
  per_page,
  accountId,
  fin_callback
...
function updateSelfAnalysesByDate({
  has_more,
  next_page_url,
  resultSet,
  from
...
export const acquireFloatAppSelfAnalysesByDate = ({
  url,
  per_page,
  accountId,
  from,
