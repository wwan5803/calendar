...
export default connect(state => ({
    ...
    class TimezoneDropDown extends Component {
        ...
        render() {
            ...
            return (
                <div>
                    <TitleRow reset={this.resetTimeZone} language={language} label={langContent[language].components.ecoCalendar.labels.timeZone} />
...
//       if (
//         this.props.timezoneState.size === 0 &&
//         nextProps.timezoneState.size > 0
//       ) {
//         const { timezoneState, browserEnvironment, dispatch } = nextProps;
//         const defaultTimezone = browserEnvironment
//           .get("location")
//           .get("time_zone");
//         const defaultEntity = timezoneState.get(defaultTimezone);
//         if (!defaultEntity) return null;
//         const default_gmt_offset = defaultEntity.get("gmt_offset");
//         const defaultOffset = default_gmt_offset / 3600;
...
//           style={{
//             marginLeft:
//               screenSize === LAPTOP || screenSize === DESKTOP ? 20 : 0,
//             width: 140,
